...
proc sim_start {AVALONMODE TESTCASE} {
  ...
  switch $AVALONMODE {
    0 {
        ...
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq2
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq3
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq4
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq5
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq6
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq7
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq8
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq9
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq10
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq11
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq12
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq13
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq_humair2
        add wave /avalon_assertions_wrapper/duv/binded/assert_waitreq_humair2b
