...
Comme on peut le voir, nous mettons à jour le flag `is_active. Ce flag est utilisé dans la procedure suivante qui va attendre que l'événement `start_record` soit déclenché pour continuer l'acquisition.
